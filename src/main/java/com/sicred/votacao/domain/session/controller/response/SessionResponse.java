...
public class SessionResponse {
    ...
    public SessionResponse(Long id, String name, LocalDateTime endSession, Status status, Boolean winner, AssociateResponse associate) {
        this.id = id;
        this.name = name;
    ...
    public static SessionResponse of(Session session) {
        ...
        return new SessionResponse(session.getId(),session.getName(),session.getEndSession(),session.getStatus(),null,AssociateResponse.of(session.getAssociate()));
    }
